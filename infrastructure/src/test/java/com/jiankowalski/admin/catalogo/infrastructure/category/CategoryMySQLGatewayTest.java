...
class CategoryMySQLGatewayTest {
    ...
    @Test
    public void givenAValidCategory_whenCalledCreate_shouldReturnANewCategory() {
    ...
    @Test
    public void givenAValidCategory_whenCalledUpdate_shouldReturnCategoryUpdated() {
        final var expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;

        final var aCategory = Category
                .newCategory("Film", "A menos", true);
        Assertions.assertEquals(0, categoryRepository.count());
    ...
    @Test
    public void givenAPrePersistedCategoryAndInvalidCategoryId_whenTryToDelete_shouldDeleteCategory() {
    ...
    public void givenAValidCategoryIdNotStored_whenCallsFindById_shouldReturnEmpty() {
        Assertions.assertEquals(0, categoryRepository.count());
        final var actualEntity = categoryGateway.findById(CategoryID.from(""));
